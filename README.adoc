...
On a search, the data sources are fetched and stored in the user's
cache.

The following method fetches all the documents from the dataset, then saves them to the `./data` folder in YAML format.
